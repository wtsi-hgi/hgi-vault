...
proposed set up, this is possible and any additional archive events can
be added by the sweeper to the drainer's backlog.
...
to a directory (either relative or absolute) that contains a vault. It
...
sweeper to log what it would do, without affecting the filesystem.
