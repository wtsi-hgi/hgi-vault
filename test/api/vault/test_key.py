...
class TestVaultFileKey(unittest.TestCase):
    ...
    def test_constructor_longest(self):
        self.assertEqual(VFK(_DUMMY_LONGEST, 0x1).path,    T.Path(f"01-{_B64_DUMMY_LONGEST_FIRST_PART}/{_B64_DUMMY_LONGEST_SECOND_PART}/{_B64_DUMMY_LONGEST_THIRD_PART}"))
        self.assertEqual(VFK(_DUMMY_LONGEST, 0x12).path,   T.Path(f"12-{_B64_DUMMY_LONGEST_FIRST_PART}/{_B64_DUMMY_LONGEST_SECOND_PART}/{_B64_DUMMY_LONGEST_THIRD_PART}"))
        self.assertEqual(VFK(_DUMMY_LONGEST, 0x123).path,  T.Path(f"01/23-{_B64_DUMMY_LONGEST_FIRST_PART}/{_B64_DUMMY_LONGEST_SECOND_PART}/{_B64_DUMMY_LONGEST_THIRD_PART}"))
        self.assertEqual(VFK(_DUMMY_LONGEST, 0x1234).path, T.Path(f"12/34-{_B64_DUMMY_LONGEST_FIRST_PART}/{_B64_DUMMY_LONGEST_SECOND_PART}/{_B64_DUMMY_LONGEST_THIRD_PART}"))
    ...
    def test_reconstructor_longest(self):
        self.assertEqual(VFK_k(T.Path(f"01-{_B64_DUMMY_LONGEST_FIRST_PART}/{_B64_DUMMY_LONGEST_SECOND_PART}/{_B64_DUMMY_LONGEST_THIRD_PART}")).source,    _DUMMY_LONGEST)
        self.assertEqual(VFK_k(T.Path(f"12-{_B64_DUMMY_LONGEST_FIRST_PART}/{_B64_DUMMY_LONGEST_SECOND_PART}/{_B64_DUMMY_LONGEST_THIRD_PART}")).source,    _DUMMY_LONGEST)
        self.assertEqual(VFK_k(T.Path(f"01/23-{_B64_DUMMY_LONGEST_FIRST_PART}/{_B64_DUMMY_LONGEST_SECOND_PART}/{_B64_DUMMY_LONGEST_THIRD_PART}")).source, _DUMMY_LONGEST)
        self.assertEqual(VFK_k(T.Path(f"12/34-{_B64_DUMMY_LONGEST_FIRST_PART}/{_B64_DUMMY_LONGEST_SECOND_PART}/{_B64_DUMMY_LONGEST_THIRD_PART}")).source, _DUMMY_LONGEST)
    ...
    def test_equality_long(self):
        self.assertEqual(VFK(_DUMMY_LONG, 0x12),  VFK_k(T.Path(f"12-{_B64_DUMMY_LONGEST_FIRST_PART}/{_B64_DUMMY_LONG_SECOND_PART}")))
        self.assertEqual(VFK(_DUMMY_LONG, 0x123), VFK_k(T.Path(f"01/23-{_B64_DUMMY_LONGEST_FIRST_PART}/{_B64_DUMMY_LONG_SECOND_PART}")))

    def test_equality_longest(self):
        self.assertEqual(VFK(_DUMMY_LONGEST, 0x12),  VFK_k(T.Path(f"12-{_B64_DUMMY_LONGEST_FIRST_PART}/{_B64_DUMMY_LONGEST_SECOND_PART}/{_B64_DUMMY_LONGEST_THIRD_PART}")))
        self.assertEqual(VFK(_DUMMY_LONGEST, 0x123), VFK_k(T.Path(f"01/23-{_B64_DUMMY_LONGEST_FIRST_PART}/{_B64_DUMMY_LONGEST_SECOND_PART}/{_B64_DUMMY_LONGEST_THIRD_PART}")))
